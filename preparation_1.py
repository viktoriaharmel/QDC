...
# Function to create a data report for a DataFrame
...
# Function to create descriptive statistics and data visualization
def create_statistics_and_visualization(file_name, data):
    ...
    if 'time' in data.columns:
        for column in numeric_columns.columns:
            ...
            # Close the plot
            plt.close()
    # Create a Pandas DataFrame for descriptive statistics
    return stats_df
...
with pd.ExcelWriter(excel_filename, engine='xlsxwriter') as writer:
    ...
    for file_name, data in all_data.items():
        # Create a separate sheet for statistics and data visualization
...
# Print a message to confirm the report generation
